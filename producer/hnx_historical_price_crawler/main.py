...
def crawl_hsx_historical_price(date_string, destination='./data/'):
    ...
    if table_tag:
        ...
        columns = ['STOCK_ID', 'CLOSE_PRICE', 'PRICE_CHANGE', 'BASE_PRICE', 'OPEN_PRICE',
                   'HIGHEST_PRICE', 'LOWEST_PRICE', 'MATCHED_VOLUME', 'MATCHED_AMOUNT',
                   'SELF_DEALED_VOLUME', 'SELF_DEALED_AMOUNT', 'RECORDED_DATE']
...
class command(Resource):
    ...
    def get(self):
        ...
        src_df = crawl_hsx_historical_price(date_string=today)
